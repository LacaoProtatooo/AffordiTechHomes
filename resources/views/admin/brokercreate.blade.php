...
<div>
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white ">
        ...
        <form action="{{ route('broker.submit') }}" method="POST" class="max-w-md mx-auto bg-white rounded-lg p-6" onsubmit="return validatePasswords()">
            @csrf
            <!--Email-->
