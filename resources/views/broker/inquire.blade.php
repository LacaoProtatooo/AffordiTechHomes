        ...
        <table class="min-w-full bg-white">
          <thead class="bg-gray-100">
            <tr>
              ...
              <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Buy Property</th>
            </tr>
          </thead>
          <tbody class="text-gray-700">
            ...
            <td class="py-3 px-4">
              <button onclick="location.href='{{route('broker.soldForm', ['property_id' => $inquire->property_id, 'customer_id' => $inquire->customer_id, 'agent_id' => $inquire->agent_id])}}'"
            ...
            <td class="py-3 px-4">
              ...
              <td class="py-3 px-4">No Agent Assign Yet</td>
            @endif
            </tr>
            @endforeach
          </tbody>
